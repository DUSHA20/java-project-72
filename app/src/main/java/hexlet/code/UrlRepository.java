...
public class UrlRepository extends BaseRepository {
    ...
    public void addPageAnalysis(
            String url, Long loadTime, Integer contentLength, Integer requestCount, Boolean isCdnUsed
    ) {
        try {
            Long urlId = getUrlIdByName(url);
            if (urlId != null) {
    ...
    public void saveUrlStatus(String url, int statusCode) throws SQLException {
        ...
        if (urlId != null) {
            try {
                PreparedStatement statement = connection.prepareStatement(
                        "INSERT INTO Links (url_id, url, statusCode, created_at) VALUES (?, ?, ?, ?)");
                statement.setLong(1, urlId);
