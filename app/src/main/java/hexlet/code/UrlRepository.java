...
public class UrlRepository extends BaseRepository {
    ...
    public void initializeDatabase() {
        try (Statement statement = connection.createStatement()) {
            ...
            System.out.println("Tables 'urls', 'Checks','TFIDFResults' and 'PageSpeedAnalysis' created successfully");
    ...
    public void addPageSpeedAnalysis(String url, String analysisResult) {
        try {
            Long urlId = getUrlIdByName(url);
            if (urlId != null) {
                PreparedStatement statement = connection.prepareStatement("INSERT INTO PageSpeedAnalysis (url_id, analysis_result, created_at) VALUES (?, ?, ?)");
                statement.setLong(1, urlId);
    ...
    public List<PageSpeedAnalysis> getAllPageSpeedAnalysis() {
        List<PageSpeedAnalysis> pageSpeedAnalysisList = new ArrayList<>();
        String sql = "SELECT * FROM PageSpeedAnalysis"; // Получаем все данные из таблицы PageSpeedAnalysis
        try (PreparedStatement statement = connection.prepareStatement(sql);
             ResultSet resultSet = statement.executeQuery()) {
            while (resultSet.next()) {
                ...
                pageSpeedAnalysis.setAnalysisResult(resultSet.getString("analysis_result"));
